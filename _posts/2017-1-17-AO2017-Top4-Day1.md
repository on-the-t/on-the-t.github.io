...
The first half of the draw is done and we've already seen a number of surprises. In this post, Tennis Australia's GIG has put together win probability charts to capture the ebbs and flows of 4 of the most contested matches on Day 1. These charts not only consider player pre-match Elo ratings but also their form during the match, updating their expectation of winning points as the match progresses. The size of the points indicate point importance, the larger the relative size the larger the relative importance of the point.
