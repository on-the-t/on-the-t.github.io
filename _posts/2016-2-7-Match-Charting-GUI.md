...
The [Match Charting Project (MCP)](http://www.tennisabstract.com/blog/2013/11/26/the-match-charting-project/), spearheaded by Jeff Sackmann of [TennisAbstract](http://www.tennisabstract.com/) and [Heavy Topspin](http://heavytopspin.com/), is trying to change all of that. The MCP is an effort to gather shot-by-shot descriptions of the events in tennis matches using volunteer coders. The MCP has been going strong for several years. But with the number of matches that occur each season (equivalent to 15 matches per day for the WTA and ATP not even including Challenger of qualifying matches!), more contributors are needed.
...
I'll continue to maintain the current version. Your feedback is welcome.
